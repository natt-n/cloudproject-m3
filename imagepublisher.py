...
topic_name = "pedestrian-detection-input";   # change it for your topic name if needed
...
for image in os.listdir("Dataset_Occluded_Pedestrian/"):
    with open("Dataset_Occluded_Pedestrian/"+image, "rb") as f:
